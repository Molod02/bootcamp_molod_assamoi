...
Each homework will be in its own subfolder (`homework00`, `homework01`, etc.), numbered to match the stage. Include all required files for grading.
...
Keep project files organized and clearly named. The project folder structure is set up in Stage 02.
